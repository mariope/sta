## Contributing to barronsCOT

The goal of this guide is to help you contribute to barronsCOT as quickly and as easily possible. The guide is divided into two main pieces:
...
1.  Check that you're using the latest version of barronsCOT. It's quite
    possible that the problem you're experiencing has already been fixed.
    
2.  Spend a few minutes looking at the existing issues. It's possible that
